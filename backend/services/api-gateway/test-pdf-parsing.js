...
// Run this from: backend/services/api-gateway directory
...
async function testPDFParsing() {
  ...
  // Test 1: Check if @thednp/dommatrix is installed
  console.log('1. Checking @thednp/dommatrix package...');
  try {
    const dommatrix = await import('@thednp/dommatrix');
    console.log('   ✅ @thednp/dommatrix imported successfully');
    ...
    console.log('   ❌ Failed to import @thednp/dommatrix:', error.message);
    console.log('   💡 Run: npm install @thednp/dommatrix');
    return;
  }
